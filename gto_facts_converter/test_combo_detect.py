...
def test_high_card_straight():
    ...
    assert draws1 == {'straight_draw': (False, None), 'flush_draw': False}
...
def test_one_pair_straight_flush():
    ...
    assert draws2 == {'straight_draw': (True, [[5], [10]]), 'flush_draw': (True, 1)}
...
def test_royal_flush():
    ...
    assert draws3 == {'straight_draw': (False, None), 'flush_draw': False}
...
def test_four_of_a_kind():
    ...
    assert draws4 == {'straight_draw': (False, None), 'flush_draw': False}
...
def test_flush_draw():
    ...
    assert draws5 == {'straight_draw': (True, [[10, 11]]), 'flush_draw': False}
...
def test_straight_flush_draw():
    ...
    assert draws6 == {'straight_draw': (True, [[8], [13]]), 'flush_draw': (True, 1)}
...
def test_staight_draw():
    ...
    assert draws6 == {'straight_draw': (True, [[1, 2], [2], [7], [7, 8]]), 'flush_draw': False}
